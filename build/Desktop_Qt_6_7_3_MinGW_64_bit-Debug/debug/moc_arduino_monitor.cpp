/****************************************************************************
** Meta object code from reading C++ file 'arduino_monitor.h'
**
...
#error "The header file 'arduino_monitor.h' doesn't include <QObject>."
...
void ArduinoMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tempUpdated((*reinterpret_cast< std::add_pointer_t<float>>(_a[1]))); break;
        case 1: _t->doorStatusUpdated((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->criticalAlert((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        {
            using _t = void (ArduinoMonitor::*)(float );
            if (_t _q_method = &ArduinoMonitor::tempUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ArduinoMonitor::*)(bool , int );
            if (_t _q_method = &ArduinoMonitor::doorStatusUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ArduinoMonitor::criticalAlert; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ArduinoMonitor::tempUpdated(float _t1)
{
...
// SIGNAL 1
void ArduinoMonitor::doorStatusUpdated(bool _t1, int _t2)
{
...
// SIGNAL 2
void ArduinoMonitor::criticalAlert(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
